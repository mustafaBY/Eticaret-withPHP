	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group dob">
					<div class="col-sm-12">
						...
						Kullanıcı Adı: <input type="text" class="form-control"  required="" name="kullanici_adsoyad" value="<?php echo $kullanicicek['kullanici_adsoyad'] ?>">
					</div>
				...
				<div class="form-group dob">
					<div class="col-sm-6">
						Şehir: <input type="text" class="form-control" name="kullanici_il"    value="<?php echo $kullanicicek['kullanici_il'] ?>">
					</div>
					<div class="col-sm-6">
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle"><img width="400" src="dimg/sifremi-unuttum.jpg"></a></center>
			</div>
		</div>
	</div>
</form>
