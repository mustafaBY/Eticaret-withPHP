...
$kullanici_adsoyaddizi=explode(" ", $kullanici_adsoyad);

$kullanici_ad=$kullanici_adsoyaddizi[0];
$kullanici_soyad=$kullanici_adsoyaddizi[1];
...
$kullanici_adresiyaz=$kullanicicek['kullanici_adres'];
...
$request->setCallbackUrl("http://abc.com/iyzico/sonuc.php?siparis_no=$siparis_no");
