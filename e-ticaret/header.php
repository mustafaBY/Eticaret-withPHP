...
<body>
	<div id="wrapper">
		<div class="header"><!--Header -->
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-4 main-logo animated pulse">
								...
								<div class="regwrap">
									<div class="row">
										...
										<div class="col-md-6">
											...
											<p>
												Hala bize katılmadın mı? Eğlenerek güvenli şekilde alışveriş yapmak için hemen kayıt olmalısın!
											</p>
										...
										<div class="col-md-12">
											<form action="arama" method="POST" class="form-horizontal" role="form">
												<div class="form-group">
													...
													<button name="arama" class="btn btn-default btn-xs control-label">Ara</button>
													<div class="col-sm-10">
											...
											<tbody>
												...
												while($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
													...
													<tr>
														...
														<td><a href="product.htm"><?php echo $uruncek['urun_ad'] ?></a>
