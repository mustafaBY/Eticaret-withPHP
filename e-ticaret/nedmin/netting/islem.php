...
if (isset($_POST['kullanicikaydet'])) {
	...
	//htmlspecialchars yerine strip_tags ta kullanıp html i temızleyebilirsin önlem!
...
//dönen satır sayısı rowCount aşağıda dönen varsa 1 se 
	$say=$kullanicisor->rowCount();
...
if (isset($_POST['hakkimizdaayarkaydet'])) {
	...
	Copy paste işlemlerinde tablo ve işaretli satır isminin değiştirildiğinden emin ol!
