...
//Sayfalara erişmemek için 1.YÖNTEM sızılması kolay yukarıdaki önerilen
/*
...
<!--Çoklu urun fotosu yüklemek için dropzonelar-->
 <!-- Dropzone.js -->
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-cogs"></i> Site Ayarları <span class="fa fa-cogs"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="mail-ayarlar.php">E-mail Ayarlar</a></li>                                                                              
                  </ul>
                </li>
