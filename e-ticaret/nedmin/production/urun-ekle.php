        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <!----- Kategori seçme başlangıç FOREİGN KEY ATAMA ------>
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="first-name" name="urun_ad" placeholder="Ürün adı giriniz" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
